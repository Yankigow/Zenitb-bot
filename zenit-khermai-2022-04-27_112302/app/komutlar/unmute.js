...
if(!args[0]) return message.channel.send(`**Yanlış Kullanım Birini Etiketle! Uyarı sisteminin komutlarını görmek için \`z!uyarı-sistemi\` yazabilirsiniz.**`)
...
if(uyarilog) {
  message.guild.channels.cache.get(uyarilog.id).send(new Discord.MessageEmbed()
                          .setColor("YELLOW")
                          .setTitle("ZeZe 2.5 | Uyarı Sistemi")
