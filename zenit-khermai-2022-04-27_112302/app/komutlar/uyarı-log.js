...
if(!kanaletiket) return message.reply("UyarıLog kanalini etiketlemelisin! (zeq 2.5 Uyari Sistemi)")
db.set(`uyarilog_${message.guild.id}`, kanaletiket)
message.channel.send(`Uyari Log kanali ${kanaletiket} olarak ayarlandi (zeq 2.5 Uyari Sistemi)`)
}
