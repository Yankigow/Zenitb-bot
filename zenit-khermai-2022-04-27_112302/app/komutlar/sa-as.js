...
exports.run = async (bot, message, args) => {
  if (!args[0]) return message.channel.send(`Aç yada kapat yazmalısın!! Örnek: **z!sa-as aç**`)
  ...
  if (args[0] === 'aç') {
    ...
    message.channel.send(`✅ **Artık bot Sa diyince As diyecek. Kapatmak için "\`z!sa-as kapat\`" yazmalısın.**`)
